...
@objc public protocol LynnBubbleViewDataSource : class {
...
open class LynnBubbleTableView: UITableView {
   ...
   @objc weak var bubbleDataSource:LynnBubbleViewDataSource?
...
//        self.estimatedRowHeight = 80
        ...
        self.register(UINib(nibName: "Someone_sBubbleViewCell", bundle: nil), forCellReuseIdentifier: "someonesBubbleCell")
