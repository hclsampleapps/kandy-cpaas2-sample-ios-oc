...
- (void)viewDidLoad {
    ...
    [self.tblVw_Directory registerNib:[UINib nibWithNibName:@"CustomeCellTableViewCell" bundle:nil] forCellReuseIdentifier:@"CustomeCellTableViewCell"];
    [self.tblVw_Directory setSeparatorStyle:UITableViewCellSeparatorStyleSingleLine];
...
{
    return [CustomeCellTableViewCell height];
}
...
{
       static NSString *simpleTableIdentifier = @"CustomeCellTableViewCell";
       CustomeCellTableViewCell *cell = (CustomeCellTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
            if (cell == nil) {
                cell = [[CustomeCellTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:simpleTableIdentifier];
                }
