...
- (void)viewDidLoad {
    ...
    [self.tblVw registerNib:[UINib nibWithNibName:@"CustomeCellTableViewCell" bundle:nil] forCellReuseIdentifier:@"CustomeCellTableViewCell"];
    [self.tblVw setSeparatorStyle:UITableViewCellSeparatorStyleSingleLine];
