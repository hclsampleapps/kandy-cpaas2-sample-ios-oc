...
@objc public enum BubbleDataType: Int {
    case none = -1
    case me = 0
    case someone = 1
}
...
public class LynnUserData :NSObject {
  ...
  @objc  internal(set) public var userNickName:String?
    public var userInfo: AnyObject?
   @objc init(userUniqueId userId:String, userNickName nick:String? = nil, userProfileImage profileImg:UIImage? = nil, additionalInfo userInfo:AnyObject? = nil) {
...
public class LynnBubbleData: NSObject {
    ...
    @objc convenience init(userData:LynnUserData, dataOwner type:BubbleDataType,
